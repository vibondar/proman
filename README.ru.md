...
**Версия:** 0.3.17 · [Changelog](./CHANGELOG.md)
...
1. Откройте **[Releases](https://github.com/vibondar/proman/releases)** и скачайте свежий `proman-*.vsix` (например `proman-0.3.17.vsix`).
